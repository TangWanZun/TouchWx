...
Page({
  ...
  vipCardUpData(index) {
    ...
    //更新电子券数据
    this.getecardList(dataList.VipCode, dataList.CarId);
  },
  /**
   * 数据提交
   */
  ...
  //页面滚动触发
  onPageScroll(e) {
    if (this.data.menuFixed == (e.scrollTop * 1 > this.menuTop * 1)) {
      return;
    }
